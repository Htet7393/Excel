...

{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        ///Ilist - list interface in C#
        ///if i change the contents of one cell, other cells might also change its contents based on dependancy
        /// <summary>
